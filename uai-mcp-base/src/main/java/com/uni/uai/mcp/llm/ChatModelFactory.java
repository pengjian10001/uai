...
public class ChatModelFactory {
	...
	static {
		String baseUrl = getConfig("UAI_LLM_BASE_URL", "uai.llm.base-url", "https://openapi-ait.ke.com/v1");
		String modelName = getConfig("UAI_LLM_MODEL_NAME", "uai.llm.model-name", "gpt-5-mini");
