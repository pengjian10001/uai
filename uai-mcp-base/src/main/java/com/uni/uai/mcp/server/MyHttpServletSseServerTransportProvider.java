...
import com.uni.uai.mcp.utils.LRUMap;
...
public class MyHttpServletSseServerTransportProvider extends HttpServlet implements McpServerTransportProvider {

	private static final long serialVersionUID = 1L;

	/** Logger for this class */
	private static final Logger logger = LoggerFactory.getLogger(MyHttpServletSseServerTransportProvider.class);
	...
	private final Map<String, McpServerSession> sessions = new LRUMap<String, McpServerSession>(10000);
	 ...
	 */
	public MyHttpServletSseServerTransportProvider(ObjectMapper objectMapper, String messageEndpoint,
			String sseEndpoint) {
	 ...
	 * @param sseEndpoint The endpoint path where clients will establish SSE connections
	 */
	public MyHttpServletSseServerTransportProvider(ObjectMapper objectMapper, String baseUrl, String messageEndpoint,
			String sseEndpoint) {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//McpExtendUtil.modifySession(session);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//加上日志
			McpExtendUtil.log("mcp jsonrpcessage", message);
			//设置logId
			McpExtendUtil.setLogpId(message);
			...
			McpExtendUtil.logError("mcp Error processing message", e);
			try {
				...
				McpExtendUtil.logError("mcp Failed to send error response", ex);
	...
	public static class Builder {
		 ...
		 */
		public MyHttpServletSseServerTransportProvider build() {
			...
			return new MyHttpServletSseServerTransportProvider(objectMapper, baseUrl, messageEndpoint, sseEndpoint);
		}
